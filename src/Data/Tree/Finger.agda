...
instance
  ...
  Foldable-Tree .foldr step init (singleton x) = step x init
  Foldable-Tree .foldr step init (deep _ pr m sf) =
...
uncons : {{Measured v a}}
  -> (Tree v a)
  -> Maybe (Pair a (Tree v a))

unsnoc : {{Measured v a}}
  -> (Tree v a)
  -> Maybe (Pair (Tree v a) a)
